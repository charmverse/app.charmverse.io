...
async function updateStarterPackNftImage() {
  ...
  // await uploadStarterPackArtwork({
  //   displayName: 'motechFR',
  //   tokenId: 55,
  //   season: currentSeason,
  //   avatar: 'https://cdn.charmverse.io/user-content/e0ec0ec8-0c1f-4745-833d-52c448482d9c/0dd0e3c0-821c-49fc-bd1a-7589ada03019/1ff23917d3954f92aed4351b9c8caa36.jpg',
  //   imageHostingBaseUrl: process.env.DOMAIN
  // });
}


updateStarterPackNftImage().then(console.log).catch(console.error);