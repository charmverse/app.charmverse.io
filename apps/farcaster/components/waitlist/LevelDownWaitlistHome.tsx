...
export function LevelDownWaitlistHome() {
  const src = `${baseUrl}/images/waitlist/level-down1.jpg`;
  ...
  return (
    <>
      ...
      <meta name='fc:frame:post_url' content={getWaitlistLevelsPostbackUrl({ currentPage: 'level-down' })} />
