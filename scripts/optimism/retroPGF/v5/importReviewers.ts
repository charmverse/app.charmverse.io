...
const reviewerData = getCsvData<ProposalRow>('../__data/optimism/reviewer_allocations.csv');

import { getProjectsFromFile, RetroApplication, spaceId } from './data';
...
async function populateProject({ project: raw }: RetroApplication, spaceRoles: { userId: string }[]) {
