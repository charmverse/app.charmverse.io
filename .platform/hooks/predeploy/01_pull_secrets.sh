...
if [[ $env_file_grep =~ ^EBSTALK_ENV_FILE=(.+)$ ]]; then
    ...
    echo "\n# end ebstalk_env_file #"  >> $ebstalk_env_file
    ...
    echo "### Merged env files generated by $0 .  In case duplicated variables the latter one takes precedence." > $APP_STAGING_DIR/.env
