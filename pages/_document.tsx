    ...
    return (
      <Html lang='en'>
        <Head>
          ...
          <meta property='og:image' content='https://6ac1594eba36.ngrok.io/images/logo_black_lightgrey_opengraph.png' />
          ...
          <meta property='twitter:image' content='https://6ac1594eba36.ngrok.io/images/logo_black_lightgrey_opengraph.png' />
        </Head>
        <body>
          <Main />
          <NextScript />
