  ...
  return (
    <Container component='main' maxWidth='xs'>
      <StyledWrapper sx={{ mt: 12, mb: 6, py: 2 }}>
        ...
        <LoginButton external href='/api/auth/signup?type=email'>
          Sign up
        </LoginButton>
        ...
        <Typography variant='caption' style={{ textAlign: 'center', margin: '8px 0', width: '100%' }}>
          Already have an account? <Link sx={{ color: blueColor, textDecoration: 'none' }} href='/api/auth/login'>Sign in</Link>
        </Typography>
      </StyledWrapper>
    </Container>
  );
