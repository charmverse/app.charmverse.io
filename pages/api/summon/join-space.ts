...
handler.use(requireKeys([{ key: 'spaceId', truthy: true }], 'body')).post(joinSpaceEndpoint);

async function joinSpaceEndpoint(req: NextApiRequest, res: NextApiResponse<Space>) {
