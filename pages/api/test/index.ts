...
import { Prisma, Space, Permission } from '@prisma/client';
import { prisma } from 'db';
import { IPagePermission } from 'lib/permissions/interfaces';
...
async function createPermission (req: NextApiRequest, res: NextApiResponse<Space[]>) {

  const permission = req.body as IPagePermission;
