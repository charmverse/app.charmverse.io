...
export const isTestEnv = process.env.REACT_APP_APP_ENV === 'test' || process.env.NODE_ENV === 'test';
...
// web sockets
export const websocketsHost = process.env.REACT_APP_WEBSOCKETS_HOST;
// Google config
...
export const googleOAuthClientIdSensitive =
  process.env.GOOGLE_OAUTH_CLIENT_ID_SENSITIVE || process.env.REACT_APP_GOOGLE_OAUTH_CLIENT_ID_SENSITIVE;
