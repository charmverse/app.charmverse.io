              ...
              >
                ...
                >
                  <Box display='flex' alignItems='center'>
                    ...
                    >
                      Connected{' '}
                      {conditionalPlural({ word: 'Identity', plural: 'Identities', count: totalIntegrations })}
                    </Typography>
                  </Box>
                  <Box
                    display={{
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        height={20}
                        src={
                          discordConnected ? '/images/discord-logo-colored.png' : '/images/discord-logo-greyscale.png'
                        }
                      />
                    </Tooltip>
                    <Tooltip
