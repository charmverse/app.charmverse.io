...
export function BulletListIcon() {
  return (
    <svg style={{ transform: 'scale(1.4, 1.4)' }} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
...
export function TodoListIcon(props: any) {
  return (
    <svg style={{ transform: 'scale(0.8, 0.8)' }} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' {...props}>
