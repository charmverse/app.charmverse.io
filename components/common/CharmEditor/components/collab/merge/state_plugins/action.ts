...
export const copyChange = function (view: EditorView, from: number, to: number) {
...
export const deleteContent = function (merge, view, diffMark, mappingNeeded = true) {
  ...
  const rebasedTo = rebasedMapping.map(diffMark.attrs.to);
