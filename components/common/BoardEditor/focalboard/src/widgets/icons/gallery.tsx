...
export default function GalleryIcon (props: SVGProps<any> & { disabled?: boolean }): JSX.Element {
  const theme = useTheme();
  const fill = props.disabled ? theme.palette.action.disabled : 'currentColor';
