...
import PageBanner, {
  randomBannerImage,
} from "components/[pageId]/DocumentPage/components/PageBanner";
...
const CardDetail = (props: Props): JSX.Element | null => {
  ...
  const setRandomHeaderImage = useCallback(
    (headerImage?: string | null) => {
      ...
      mutator.changeHeaderImage(
        card.id,
        card.fields.headerImage,
        headerImage !== null ? newHeaderImage : null
      );
    },
    ...
    <>
      {card.fields.headerImage && (
        <Box width={"100%"} mb={2}>
          <PageBanner
            focalBoard
            headerImage={card.fields.headerImage}
            setPage={({ headerImage }) => {
      ...
      <div className="CardDetail content">
        <BlockIconSelector block={card} size="l" readonly={props.readonly} />
      ...
      <div
        className="CardDetail content fullwidth content-blocks"
        style={{
          height: 150,
        }}
      >
