...
var commentsList_1 = require("./commentsList");
...
describe('components/cardDetail/CommentsList', function () {
    ...
    test('comments show up', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        {(0, testUtils_1.wrapIntl)(<commentsList_1["default"] comments={[comment1, comment2]} rootId='root_id' cardId='card_id' readonly={false}/>)}
    ...
    test('comments show up in readonly mode', function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockStore, store, component, container, comments, newCommentSection;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    component = (<react_redux_1.Provider store={store}>
        {(0, testUtils_1.wrapIntl)(<commentsList_1["default"] comments={[comment1, comment2]} rootId='root_id' cardId='card_id' readonly={true}/>)}
      </react_redux_1.Provider>);
                    container = null;
                    return [4 /*yield*/, (0, test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            var result;
