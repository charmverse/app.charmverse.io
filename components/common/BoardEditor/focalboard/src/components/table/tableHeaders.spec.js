...
describe('components/table/TableHeaders', function () {
    ...
    test('should match snapshot', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            component = (0, testUtils_1.wrapDNDIntl)(<tableHeaders_1["default"] board={board} cards={[card]} activeView={view} views={[view]} readonly={false} resizingColumn='' offset={0} columnRefs={new Map()}/>);
