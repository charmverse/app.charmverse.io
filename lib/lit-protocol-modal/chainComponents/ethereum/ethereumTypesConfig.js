...
const ethereumTypesConfig = {
  ...
  conditionTypeData: {
    ...
    poap: {
      label: 'POAP Collectors', img: `/images/poap_logo.svg`, requiresMultipleConditions: true,
      supportedChains: [ 'ethereum', 'xdai' ]
    },
    cask: {
      label: 'Active Subscriber (Powered by Cask)', img: `/images/cryptoLogos/cask-logo.svg`, requiresMultipleConditions: false,
