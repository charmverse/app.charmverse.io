...
export function calculateVoteStatus ({ deadline, type, status, threshold, userVotes }:{userVotes: UserVote[], threshold: Vote['threshold'], status: Vote['status'], type: Vote['type'], deadline: Vote['deadline']}) {
