        ...
        comments: [
          {
            ...
            content: {
              type: 'doc',
              content: [{ type: 'paragraph', content: [{ text: 'Commenter just commented', type: 'text' }] }]
            }
          },
          {
            spaceId: space1.id,
              ...
              content: [
                {
                  type: 'paragraph',
                  content: [
                    { text: 'Make this change ', type: 'text' },
                    {
                      type: 'mention',
                      attrs: {
                        id: '9899800b-407e-4709-a15a-9b2bf1d6ad2d',
                        type: 'user',
                        track: [],
                        value: pageCommenter.id,
                        createdAt: '2022-11-03T09:37:26.670Z',
                        createdBy: pageCommenter2.id
                      }
                    },
                    { text: ' dsadsadasd dsadsadsa', type: 'text' }
                  ]
                }
              ]
            }
