...
export enum WebhookEventNames {
  BountyCompleted = 'reward.completed',
  BountyApplicationCreated = 'reward.application.created',
  BountyApplicationRejected = 'reward.application.rejected',
  BountyApplicationAccepted = 'reward.application.accepted',
  BountyApplicationSubmitted = 'reward.application.submitted',
  BountyApplicationPaymentCompleted = 'reward.payment.completed',
  BountySuggestionCreated = 'reward.suggestion.created',
  BountyApplicationApproved = 'reward.application.approved',
  BountyInlineCommentCreated = 'reward.inline_comment.created',
  BountyMentionCreated = 'reward.mention.created',
