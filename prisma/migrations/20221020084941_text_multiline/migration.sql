...
-- AlterEnum
BEGIN;
CREATE TYPE "MemberPropertyType_new" AS ENUM ('text', 'textMultiline', 'number', 'email', 'phone', 'url', 'select', 'multiselect', 'role', 'profile_pic', 'timezone', 'wallet_address', 'name', 'discord', 'twitter');
